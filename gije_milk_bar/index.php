...
if (!isset($_SESSION['Email']) && !isset($_SESSION['manname'])) {
    header("Location: index.html");
}else{
  $email = $_SESSION['Email'];
  $query=mysqli_query($conn,"SELECT * FROM `staff` WHERE `Email_Address`='$email'")or die(mysqli_error());
...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Gije Milk Bar ~ Manager Homepage</title>
               ...
               <div class="col-xl-4 col-lg-4 col-md-12">
                  <div class="banner_main_text">
                     ...
                     <div class="titlepage">
                        ...
                        <p>Welcome Manager, <?php echo $row['Name']; ?>! </p>
         ...
         <div class="container-fluid">
            <div class="row d_flex">
               <div class="col-xl-7 col-lg-7 col-md-12 padding_lert">
                  <div class="about_img">
                     <figure><img src="images/staff.jpg" alt="#"/></figure>
                  </div>
               </div>
               <div class="col-xl-5 col-lg-5 col-md-12">
                  <div class="about_text">
                     <div class="titlepage">
                        <h2>Staff</h2>
                        <p>The following are service supervisors that are under your management:</p>
                     <table id="printTable">
...
$fil = $row['Staff_ID'];
$sql = "SELECT `Staff_ID`, `Name`, `Job_Title`, `Email_Address` FROM `staff` WHERE `Job_Title` = 'Service Supervisor' AND `Supervisor` = '$fil'";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
// output data of each row
while($row = $result->fetch_assoc()) {
echo "<tr><td>" . $row["Staff_ID"] . "</td><td>" . $row["Name"] . "</td><td>" . $row["Email_Address"] . "</td><td>" . $row["Job_Title"] . "</td></tr>";
}
echo "</table>";
            ...
            <div class="row d_flex">
               ...
               <div class="col-xl-5 col-lg-5 col-md-12">
                  <div class="about_text">
                     <div class="titlepage">
                        <h2>Customers</h2>
                        <p>The following are the customers under our system:</p>
 <table id="printTable">
<tr style="text-align: left;
  padding: 8px;">
<th style="text-align: left;
...
$sql = "SELECT `Customer_ID`, `Name`, `Contact_No`, `Address`, `Email_Address` FROM `customer`";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
// output data of each row
while($row = $result->fetch_assoc()) {
echo "<tr><td>" . $row["Customer_ID"] . "</td><td>" . $row["Name"] . "</td><td>" . $row["Contact_No"] . "</td><td>" . $row["Address"] . "</td><td>" . $row["Email_Address"] . "</td></tr>";
}
echo "</table>";
} else { echo "No results"; }
$conn->close();
...
// output data of each row
while($row = $result->fetch_assoc()) {
echo "<tr><td>" . $row["Code"] . "</td><td>" . $row["Order_ID"] . "</td><td>" . $row["Product_ID"] . "</td><td>" . $row["Quantity"] . "</td><td>" . $row["Price"] . "</td></tr>";
}
echo "</table>";
} else { echo "No results"; }
$conn->close();
...
?>
  ...
  <fieldset>
    <legend>Delete Service Representative Or Product:</legend>
    Input ID:<br>
    <input type="text" required="" name="id" placeholder="Input ID...">
    <br>
    Select Item:<br>
  <input list="module" name="mod" placeholder="Select Item...">
  <datalist id="module">
    <option value="Service Representative">
...
<form method="POST" action="insertion.inc.php">
  <fieldset>
    <legend>Registration for Service Representative:</legend>
    Name:<br>
    ...
    <br>
    <input type="text" required="" hidden name="mid" value="<?php echo $row['Staff_ID']; ?>">
    Password:<br>
    ...
    <br><br>
    <input type="submit" name="addsr" value="Register">
  </fieldset>
</form>
<br>
<form method="POST" action="insertion.inc.php">
  <fieldset>
    ...
    Description:<br>
    <textarea type="text" required="" name="desc" placeholder="Description..."></textarea>
    <br>
    Quantity:<br>
    <input type="text" required="" name="quan" placeholder="Enter Quantity...">
    <br>
    Expiry Date:<br>
    <input type="date" min="<?= date('Y-m-d'); ?>" required="" name="exp" placeholder="Expiry Date...">
    <br>
    Price:<br>
    <input type="text" required="" name="price" placeholder="Price (in .kshs)...">
    <br><br>
