...
if (!isset($_SESSION['Email1']) && !isset($_SESSION['srname'])) {
...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Gije Milk Bar ~ Service Supervisor Homepage</title>
               ...
               <div class="col-xl-4 col-lg-4 col-md-12">
                  <div class="banner_main_text">
                     ...
                     <div class="titlepage">
                        ...
                        <p>Welcome Service Supervisor, <?php echo $row['Name']; ?>!
                        <br>
                        Staff ID : <?php echo $row['Staff_ID']; ?>. </p>
         ...
         <div class="container-fluid">
            <div class="row d_flex">
               <div class="col-xl-5 col-lg-5 col-md-12 order_2">
                  <div class="our_text">
                     <div class="titlepage">
                        <h2>Service Supervisor Actions</h2>
                        <form method="POST" action="insertion.inc.php">
  <fieldset>
    <legend>Update A Payment:</legend>
    Transaction ID:<br>
    <input type="text" required="" name="id" placeholder="Input ID...">
    <br>
    Select Status:<br>
  <input list="module" name="stat" placeholder="Select Status...">
  <datalist id="module">
    ...
    <br><br>
    <input type="submit" name="uppay" value="Update">
  </fieldset>
</form>
<br>
<form method="POST" action="insertion.inc.php">
  <fieldset>
    ...
    Order ID:<br>
    <input type="text" required="" name="oid" placeholder="Order ID...">
    <br>
    Staff ID:<br>
    <input type="text" required="" name="sid" placeholder="Staff ID...">
    <br>
    Select Status:<br>
  <input list="module" name="status" placeholder="Select Status...">
  <datalist id="module">
    <option value="Pending...">
    <option value="Cancelled.">
    <option value="Completed.">
    ...
    <br><br>
    <input type="submit" name="addpay" value="Submit">
  </fieldset>
</form>
<br>
                     </div>
